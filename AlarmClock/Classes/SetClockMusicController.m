...
- (void)saveData
{
    ((AlarmClockAppDelegate *)[[UIApplication sharedApplication] delegate]).musicDelegate = nil;
...
- (void)viewDidLoad {
	...
	[self restoreGUI];
	((AlarmClockAppDelegate *)[[UIApplication sharedApplication] delegate]).musicDelegate = self;
	[super viewDidLoad];
}
