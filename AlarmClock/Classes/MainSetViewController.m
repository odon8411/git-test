...
//    id musicDeleagate = ((AlarmClockAppDelegate *)[[UIApplication sharedApplication] delegate]).musicDelegate;
//    if (musicDeleagate) {
...
- (void)startClock:(int)clockID
{
	...
	[(AlarmClockAppDelegate *)[[UIApplication sharedApplication] delegate] postLocalNotification:clockIDString isFirst:YES];
